...
class SingleModelFitSet:
    ...
    def set_arg(self, arg, value):
        ...
        assert arg in ['command', 'model', 'dataset', 'outpath', 'bagpath', 'progpath']
    ...
    def write_bag(self):
        ...
        t = Template("""python ${progpath} fit -m ${model} -o ${outpath} -d ${dataset} -p '${params}'\n""")
